...
impl XyPad {
    ...
    fn xy_pad_handle_view(
        ...
        XyPadHandle::new(cx)
            ...
            .translate((LengthValue::Px(-(HANDLE_WIDTH_PX / 2.0)), LengthValue::Px(-(HANDLE_WIDTH_PX / 2.0))))
    ...
    fn update_tooltip_pos(&mut self, cx: &mut EventContext) {
        ...
        // TODO: vizia: tree is private now, not sure how to replace (no `EventContext::get_last_child`)
        ...
        let tooltip_bounds = BoundingBox {
            x: 0.0,
            y: 0.0,
            w: 150.0,
            h: 20.0,
